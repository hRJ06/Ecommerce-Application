        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mt-10 gap-14">
          <div>
            ...
            <div className="dark:text-gray-400">
              <p className="mt-6">Karnataka, India</p>

              <a href="mailto:hindolroy.2306@gmail.com" className="block mt-3">
                hindolroy.2306@gmail.com
              </a>
              ...
              <div className="flex flex-wrap gap-3 items-center mt-4">
                ...
                >
                  <a
                    href="https://twitter.com/hindol-roy"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <FaTwitter />
                ...
                >
                  <a
                    href="https://www.linkedin.com/in/hindol-roy/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <FaLinkedinIn />
      ...
      <div className="mt-4 pt-8 border-t border-gray-200 dark:border-gray-700">
        <div className="container text-center text-sm text-gray-500 dark:text-gray-400">
          <div className="flex items-center justify-center gap-2 mb-3">
            ...
            by{" "}
            <a
              href="https://roy-hindol.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
